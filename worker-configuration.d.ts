/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af972ac3f6fd7d235e826b56e760c4b5)
// Runtime types generated with workerd@1.20250508.0 2025-05-15 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		REALTIMEKIT_ORG_ID: string;
		REALTIMEKIT_API_KEY: string;
		DURABLE_MEETING: DurableObjectNamespace<import("./src/worker/index").Meeting>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REALTIMEKIT_ORG_ID" | "REALTIMEKIT_API_KEY">> {}
}
