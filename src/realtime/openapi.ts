export default {
	...
	paths: {
		'/livestreams': {
									...
									properties: {
										...
										data: {
											...
											properties: {
												status: {
													type: 'string',
													enum: ['LIVE', 'IDLE', 'ERRORED', 'INVOKED'],
												},
												name: {
													type: 'string',
												},
									...
									'example-1': {
										value: {
											...
											data: {
												...
												playback_url:
													'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.944908621410.channel.Jk1l97eJF0ME.m3u8',
												disabled: false,
											},
										},
									},
			...
			get: {
				...
				parameters: [
					{
						name: 'exclude_meetings',
						in: 'query',
						description: 'Exclude the Dyte meetings that are livestreamed.',
						schema: {
							type: 'boolean',
							default: false,
						},
										...
										data: {
											...
											properties: {
												...
												ingest_server: {
													...
													example: 'rtmps://2ec802dd47b0.global-contribute.live-video.net:443/app/',
												},
												stream_key: {
													type: 'string',
													description: 'Unique key for accessing each livestream.',
													example: 'sk_ap-south-1_fiETVh5SNa3V_MAs0NlNCkJqTokqrMbrdWyA2naII25',
												},
												playback_url: {
													type: 'string',
													description: 'The web address that viewers can use to watch the livestream.',
													example:
														'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.944908621410.channel.mA2dNqrBulpi.m3u8',
												},
												meeting_id: {
													type: 'string',
											...
											data: [
												{
													...
													meeting_id: null,
													playback_url:
														'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.811208621215.channel.mA2dNqrBulpi.m3u8',
											...
											properties: {
												livestreams: {
													...
													items: {
														...
														properties: {
															status: {
																type: 'string',
																enum: ['LIVE', 'INVOKED', 'ERRORED', 'IDLE'],
															},
															name: {
																type: 'string',
																nullable: true,
															...
															meeting_id: {
																type: 'string',
																description: 'The ID of the meeting that was livestreamed.',
															},
															created_at: {
																type: 'string',
												...
												sessions: {
													...
													properties: {
														id: {
															type: 'string',
															description: 'The ID of the livestream session.',
														},
														livestream_id: {
															type: 'string',
															description: 'The ID of the livestream.',
														...
														invoked_time: {
															type: 'string',
															description: 'The time at which the livestream was invoked.',
															format: 'date-time',
														},
														started_time: {
															type: 'string',
															description: 'The time at which the livestream was started.',
															format: 'date-time',
														},
														stopped_time: {
															type: 'string',
															description: 'The time at which the livestream was stopped.',
															format: 'date-time',
														},
														created_at: {
															type: 'string',
										...
										value: {
											...
											data: {
												livestream: {
													...
													playback_url:
														'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.855008621410.channel.ob5KQUrP5Zaf.m3u8',
									...
									'example-1': {
										value: {
											...
											data: {
												...
												playback_url:
													'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.944908621410.channel.rVKA2KM5Lunt.m3u8',
											},
										},
									},
								},
		...
		'/livestreams/{livestream_id}/reset-stream-key': {
			post: {
				tags: ['Live streams'],
									...
									'Example 1': {
										value: {
											...
											data: {
												...
												playback_url:
													'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.124408622242.channel.9Ztr6yk4vndX.m3a1',
									...
									properties: {
										...
										data: {
											...
											properties: {
												count: {
													type: 'integer',
													description: 'Count of total livestreams.',
												},
												total_ingest_seconds: {
													type: 'integer',
													description: 'Total time duration for which the input was given or the meeting was streamed.',
												},
												total_viewer_seconds: {
													type: 'integer',
													description: 'Total view time for which the viewers watched the stream.',
												},
											},
										},
									},
									...
									properties: {
										...
										data: {
											...
											properties: {
												date: {
													type: 'string',
													description: 'The livestream timestamp, provided in ISO format.',
												},
												count: {
													type: 'string',
													description: 'Count of total livestreams.',
									...
									'x-examples': {
										'Example 1': {
											...
											data: {
												session_stats: {
													sessions_count: 4,
													sessions_minutes_consumed: 243.5,
													day_stats: [
														{
															day: '2023-10-17T00:00:00.000Z',
															total_sessions: 2,
															total_session_minutes: 221,
														},
														{
															day: '2023-10-18T00:00:00.000Z',
															total_sessions: 2,
															total_session_minutes: 22.5,
														},
													],
												},
												recording_stats: {
													recording_count: 7,
													recording_minutes_consumed: 573.666666666667,
													day_stats: [
														{
															day: '2023-10-16T00:00:00.000Z',
															total_recordings: 1,
															total_recording_minutes: 14,
														},
														{
															day: '2023-10-17T00:00:00.000Z',
															total_recordings: 5,
															total_recording_minutes: 365.66666666666697,
														},
														{
															day: '2023-10-18T00:00:00.000Z',
															total_recordings: 1,
															total_recording_minutes: 194,
														},
													],
												},
											},
		...
		'/livestreams/{livestream_id}/enable': {
			put: {
				tags: ['Live streams'],
		...
		'/livestreams/{livestream_id}/disable': {
			put: {
				tags: ['Live streams'],
		...
		'/sessions/{session_id}/livestream-sessions': {
			get: {
				tags: ['Live streams'],
									...
									properties: {
										...
										data: {
											...
											properties: {
												...
												id: {
													type: 'string',
													description: 'The livestream session ID.',
												},
												stopped_time: {
													type: 'string',
													description: 'Specifies if the livestream was disabled.',
									...
									'example-1': {
										value: {
											...
											data: {
												...
												meeting_id: 'bbb03399-24e3-4b0c-90ec-172e97e636be',
												playback_url:
													'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.811208621410.channel.9Ztr6yk4vndX.a1c3',
												created_at: '2023-07-15T11:58:08.404Z',
		...
		'/livestreams/sessions/{livestream-session-id}': {
			get: {
				tags: ['Live streams'],
		...
		'/livestreams/{livestream_id}/active-livestream-session': {
			get: {
				tags: ['Live streams'],
										...
										value: {
											...
											data: {
												livestream: {
													...
													playback_url:
														'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.944908621410.channel.ob5KQUrP5Zaf.m3u8',
													created_at: '2023-07-15T07:08:26.634Z',
													updated_at: '2023-07-15T07:08:40.726Z',
													disabled: false,
												},
		...
		'/sessions/{session_id}/transcript': {
			get: {
				...
				responses: {
					'200': {
						$ref: '#/components/responses/GetSessionTranscript',
					},
				},
				security: [
					{
		...
		'/meetings/{meeting_id}': {
			...
			patch: {
				...
				requestBody: {
					$ref: '#/components/requestBodies/UpdateMeetingBody',
				},
				responses: {
					'200': {
						$ref: '#/components/responses/GetMeeting',
		...
		'/recordings/active-recording/{meeting_id}': {
			get: {
				tags: ['Recordings'],
		...
		'/recordings/track': {
			post: {
				...
				operationId: 'Start Track Recording for a Meeting',
				requestBody: {
					$ref: '#/components/requestBodies/StartTrackRecordingBody',
				},
				responses: {
					'200': {
						description: 'OK',
	...
	components: {
		...
		requestBodies: {
						...
						schema: {
							...
							properties: {
								...
								preferred_region: {
									type: 'string',
									nullable: true,
									enum: ['ap-south-1', 'ap-southeast-1', 'us-east-1', 'eu-central-1', null],
					...
					'application/json': {
						schema: {
							...
							properties: {
								...
								preferred_region: {
									type: 'string',
									enum: ['ap-south-1', 'ap-southeast-1', 'us-east-1', 'eu-central-1'],
									description: 'The region in which this meeting should be created.',
								},
								record_on_start: {
									type: 'boolean',
			...
			AddParticipantBody: {
				content: {
					'application/json': {
						schema: {
							type: 'object',
							required: ['preset_name', 'custom_participant_id'],
							properties: {
								name: {
									type: 'string',
			...
			UpdatePresetBody: {
				content: {
					'application/json': {
						schema: {
							$ref: '#/components/schemas/UpdatePreset',
						},
					},
				},
			},
			StartTrackRecordingBody: {
		...
		securitySchemes: {
			...
			OrgBearer: {
				type: 'http',
				description: 'Provide auth token obtained from Dyte CLI',
				scheme: 'bearer',
			},
		},
		responses: {
			...
			KickAllParticipants: {
				description: 'Kick all participants from a meeting',
				content: {
					'application/json': {
						schema: {
							type: 'object',
				...
				content: {
					'application/json': {
						...
						examples: {
							...
							ParticipantListWithPeerStatsSuccess: {
								$ref: '#/components/examples/ParticipantListWithPeerEventSucces',
							},
						},
					},
				},
			...
			GetSessionTranscript: {
				description: 'Returns the complete transcript of a session.',
				content: {
					'application/json': {
						schema: {
							type: 'object',
			...
			GetOverallStats: {
				description: 'Returns complete analytics of an organization',
				content: {
					'application/json': {
						schema: {
							type: 'object',
						...
						examples: {
							OverallStatsSuccess: {
								$ref: '#/components/examples/OverallStatsSuccessResponse',
							},
						},
					},
				},
			...
			GetDaywiseStats: {
				description: 'Returns daywise analytics of an organization',
				content: {
					'application/json': {
						schema: {
							type: 'object',
							properties: {
								...
								data: {
									type: 'array',
									items: {
										$ref: '#/components/schemas/DaywiseStats',
									},
								},
							},
						},
						examples: {
							DaywiseStatsSuccess: {
								$ref: '#/components/examples/DaywiseStatsSuccessResponse',
							},
						},
					},
				},
								...
								},
								{
									...
									properties: {
										data: {
											...
											required: ['custom_participant_id', 'preset_id', 'created_at', 'updated_at'],
										},
									},
								},
							],
									...
									data: {
										participant: {
											...
											quality_stats: {
												audio_stats: [],
												video_stats: [],
												peer_ids: ['bd45f5a3-44d0-4d48-a9e5-b880b39d9e1c'],
												start: null,
												end: null,
		...
		examples: {
			...
			ParticipantListSuccess: {
				summary: "success response for session's participants list",
				value: {
					success: true,
					data: {
						participants: [
			...
			ParticipantListWithPeerEventSucces: {
				summary: 'success response for sessions participants list with peer events',
				value: {
					success: true,
					data: {
						participants: [
			...
			OverallStatsSuccessResponse: {
				...
				value: {
					...
					data: {
						sessions_count: 26,
						sessions_minutes_consumed: 1323.23,
						recordings_minutes_consumed: 468.8932,
					},
				},
			},
			DaywiseStatsSuccessResponse: {
				summary: 'Daywise stats response',
				value: {
					success: true,
					data: [
						{
							date: '2022-03-01',
							sessions_count: 10,
							sessions_minutes_consumed: 123.22,
							recordings_minutes_consumed: 129.14,
						},
						{
							date: '2022-03-02',
							sessions_count: 16,
							sessions_minutes_consumed: 1278.87,
							recordings_minutes_consumed: 338.12,
						},
					],
				},
			},
		...
		schemas: {
			LivestreamBase: {
				...
				'x-examples': {
					'example-1': {
						...
						ingest_seconds: 0,
						viewer_seconds: 0,
						ingest_server: 'rtmps://1ec802dd47a1.global-contribute.live-video.net:344/app/',
						id: '58dd0b50-4147-4bb8-88d3-2ccc2e98baa0',
						stream_key: 'sk_ap-south-1_ABCrwBSdrcWn_0eG01cFGCJcRcCsflOAX3Eu4B3RyZX',
						playback_url:
							'https://2ec802dd47b0.ap-south-1.playback.live-video.net/api/video/v1/ap-south-1.100108621410.channel.Ab1l97eJF0ME.m3u8',
					},
				},
				'x-stoplight': {
					id: 'up5po48o1jatw',
			...
			Webhook: {
				...
				required: ['id', 'name', 'url', 'events', 'created_at', 'updated_at', 'enabled'],
				'x-stoplight': {
					id: 'uegu4piugofi0',
				},
			},
			...
			OrganizationListSuccessResponse: {
				...
				properties: {
					...
					paging: {
						...
						required: ['total_count', 'start_offset', 'end_offset'],
					},
				},
				required: ['success', 'data', 'paging'],
				'x-stoplight': {
					id: '7rcil57cednwx',
				},
			},
			OrganizationData: {
				...
				required: ['id', 'name', 'contact', 'website', 'apikey', 'preferred_region', 'feature_flags', 'created_at', 'updated_at'],
				'x-stoplight': {
					id: 'z3y092r3q0moi',
				},
			},
			...
			CreateChatChannelInfo: {
				...
				'x-examples': {
					'Example 1': {
						...
						custom_participant_ids: ['custom_participant_id_1'],
						visibility: 'public',
					},
				},
				'x-stoplight': {
			...
			DyteBucketConfig: {
				...
				properties: {
					enabled: {
						type: 'boolean',
						description:
							"Controls whether recordings are uploaded to Dyte's bucket. If set to false, `download_url`, `audio_download_url`, `download_url_expiry` won't be generated for a recording.",
					},
				},
				required: ['enabled'],
				'x-stoplight': {
					...
					config: {
						...
						properties: {
							...
							media: {
								...
								required: ['video', 'screenshare'],
							},
						},
						required: ['view_type', 'max_video_streams', 'max_screenshare_count', 'media'],
					},
					permissions: {
						type: 'object',
						properties: {
							...
							plugins: {
								...
								required: ['can_close', 'can_start', 'can_edit_config', 'config'],
							},
							connected_meetings: {
								type: 'object',
								properties: {
								...
								required: ['can_alter_connected_meetings', 'can_switch_connected_meetings', 'can_switch_to_parent_meeting'],
							},
							polls: {
								type: 'object',
								...
								required: ['can_create', 'can_vote', 'can_view'],
							},
							media: {
								type: 'object',
								...
								required: ['video', 'audio', 'screenshare'],
							},
							chat: {
								type: 'object',
								...
								properties: {
									...
									private: {
										...
										required: ['can_send', 'can_receive', 'text', 'files'],
									},
								},
							...
							design_tokens: {
								...
								properties: {
									...
									colors: {
										...
										required: ['brand', 'background', 'danger', 'text', 'text_on_brand', 'success', 'video_bg', 'warning'],
									},
									logo: {
										type: 'string',
									},
								},
								required: ['border_radius', 'border_width', 'spacing_base', 'theme', 'colors', 'logo'],
							},
							config_diff: {
								type: 'object',
							},
			...
			TrackLayerOutput: {
				...
				properties: {
					type: {
						type: 'string',
						enum: ['DYTE_BUCKET', 'STORAGE_CONFIG'],
			...
			ActiveSession: {
				...
				properties: {
					...
					type: {
						type: 'string',
						enum: ['meeting', 'livestream', 'participant'],
			...
			ChatMessage: {
				...
				required: ['chat_download_url', 'chat_download_url_expiry'],
				'x-stoplight': {
					id: 'cfmjvq389r0e7',
				},
			},
			Transcript: {
				...
				required: ['sessionId', 'transcript_download_url', 'transcript_download_url_expiry'],
				'x-stoplight': {
					id: 'o83nj5j36irgq',
				},
			},
			...
			Participant: {
				...
				required: ['id', 'custom_participant_id', 'preset_name', 'created_at', 'updated_at'],
				'x-stoplight': {
					id: 'l1kv59dpfts4t',
				},
			},
			Recording: {
				...
				properties: {
					...
					status: {
						type: 'string',
						enum: ['INVOKED', 'RECORDING', 'UPLOADING', 'UPLOADED', 'ERRORED', 'PAUSED'],
			...
			stopReason: {
				...
				properties: {
					reason: {
						type: 'string',
						enum: ['API_CALL', 'INTERNAL_ERROR', 'ALL_PEERS_LEFT'],
			...
			TranscriptSummary: {
				...
				required: ['sessionId', 'summaryDownloadUrl', 'summaryDownloadUrlExpiry'],
				'x-stoplight': {
					id: 'w3rn26ss3mm20',
				},
			},
